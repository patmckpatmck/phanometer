...
"fan_analyst", "beat_writer", "radio_populist", "youtube_fan") — belongs
in metadata fields only.** Never in narrative prose generated by Claude.
...
- Metadata fields where attribution IS the purpose:
  ...
  "YouTube commenters"), never the internal voice keys.
